...
Plugin local de Obsidian que hace una copia de seguridad del vault entero a una
carpeta externa, ya sea manualmente (boton o atajo) o de forma periodica mientras
Obsidian esta abierto. El efecto equivale a copiar la carpeta del vault desde el
explorador y pegarla en otra ruta.
...
- `destPath` - carpeta de destino (debe estar fuera del vault).
...
- Guardas de seguridad: destino vacio, destino dentro del vault (evita copia
  recursiva), y `isBackingUp` para evitar solapes.
